...
//Operations for mega.float.2
    ...
    functions["mega.float.2.absolute"] = StandardFunction { Math.abs((it.execute("value") as Float).toDouble()).toFloat() }
    functions["mega.float.2.literal"] = StandardFunction { it.call().literal }
    ...
    functions["mega.float.2.sum"] = StandardFunction { it.executeSequence<Float>("values").fold(0f) { sum, it -> (sum + it) } }
...
//Operations for mega.float.4
    ...
    functions["mega.float.4.absolute"] = StandardFunction { Math.abs((it.execute("value") as Float).toDouble()).toFloat() }
    functions["mega.float.4.literal"] = StandardFunction { it.call().literal }
    ...
    functions["mega.float.4.sum"] = StandardFunction { it.executeSequence<Float>("values").fold(0f) { sum, it -> (sum + it) } }
...
//Operations for mega.float.8
    ...
    functions["mega.float.8.sum"] = StandardFunction { it.executeSequence<Double>("values").fold(0.0) { sum, it -> (sum + it) } }
    functions["mega.float.8.product"] = StandardFunction { it.executeSequence<Double>("values").fold(1.0) { product, it -> (product * it) } }

//Operations for mega.integer.signed.1
    ...
    functions["mega.integer.signed.1.literal"] = StandardFunction { it.call().literal }
    ...
    functions["mega.integer.signed.1.sum"] = StandardFunction { it.executeSequence<Byte>("values").fold(0.toByte()) { sum, it -> (sum + it).toByte() } }
    functions["mega.integer.signed.1.product"] = StandardFunction { it.executeSequence<Byte>("values").fold(1.toByte()) { product, it -> (product * it).toByte() } }

//Operations for mega.integer.signed.2
    ...
    functions["mega.integer.signed.2.literal"] = StandardFunction { it.call().literal }
    ...
    functions["mega.integer.signed.2.sum"] = StandardFunction { it.executeSequence<Short>("values").fold(0.toShort()) { sum, it -> (sum + it).toShort() } }
    functions["mega.integer.signed.2.product"] = StandardFunction { it.executeSequence<Short>("values").fold(1.toShort()) { product, it -> (product * it).toShort() } }

//Operations for mega.integer.signed.4
    ...
    functions["mega.integer.signed.4.sum"] = StandardFunction { it.executeSequence<Int>("values").fold(0) { sum, it -> (sum + it) } }
    functions["mega.integer.signed.4.product"] = StandardFunction { it.executeSequence<Int>("values").fold(1) { product, it -> (product * it) } }

//Operations for mega.integer.signed.8
    ...
    functions["mega.integer.signed.8.literal"] = StandardFunction { it.call().literal }
    ...
    functions["mega.integer.signed.8.sum"] = StandardFunction { it.executeSequence<Long>("values").fold(0L) { sum, it -> (sum + it) } }
    functions["mega.integer.signed.8.product"] = StandardFunction { it.executeSequence<Long>("values").fold(1L) { product, it -> (product * it) } }

//Operations for mega.integer.unsigned.1
    functions["mega.integer.unsigned.1.literal"] = StandardFunction { it.call().literal }
    ...
    functions["mega.integer.unsigned.1.sum"] = StandardFunction { it.executeSequence<Byte>("values").fold(0.toByte()) { sum, it -> (sum + it).toByte() } }
    functions["mega.integer.unsigned.1.product"] = StandardFunction { it.executeSequence<Byte>("values").fold(1.toByte()) { product, it -> (product * it).toByte() } }

//Operations for mega.integer.unsigned.2
    functions["mega.integer.unsigned.2.literal"] = StandardFunction { it.call().literal }
    ...
    functions["mega.integer.unsigned.2.sum"] = StandardFunction { it.executeSequence<Short>("values").fold(0.toShort()) { sum, it -> (sum + it).toShort() } }
    functions["mega.integer.unsigned.2.product"] = StandardFunction { it.executeSequence<Short>("values").fold(1.toShort()) { product, it -> (product * it).toShort() } }

//Operations for mega.integer.unsigned.4
    functions["mega.integer.unsigned.4.literal"] = StandardFunction { it.call().literal }
    ...
    functions["mega.integer.unsigned.4.sum"] = StandardFunction { it.executeSequence<Int>("values").fold(0) { sum, it -> (sum + it) } }
    functions["mega.integer.unsigned.4.product"] = StandardFunction { it.executeSequence<Int>("values").fold(1) { product, it -> (product * it) } }

//Operations for mega.integer.unsigned.8
    functions["mega.integer.unsigned.8.literal"] = StandardFunction { it.call().literal }
    ...
    functions["mega.integer.unsigned.8.sum"] = StandardFunction { it.executeSequence<Long>("values").fold(0L) { sum, it -> (sum + it) } }
    functions["mega.integer.unsigned.8.product"] = StandardFunction { it.executeSequence<Long>("values").fold(1L) { product, it -> (product * it) } }

//Conversions
//Conversions from mega.float.2
...
//Conversions from mega.integer.signed.1
...
//Conversions from mega.integer.signed.2
...
//Conversions from mega.integer.signed.4
...
//Conversions from mega.integer.signed.8
...
//Conversions from mega.integer.unsigned.1
...
//Conversions from mega.integer.unsigned.2
...
//Conversions from mega.integer.unsigned.4
...
//Conversions from mega.integer.unsigned.8

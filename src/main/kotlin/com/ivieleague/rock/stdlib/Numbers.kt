...
//Conversions from rock.float.2
    functions["rock.float.2_to_rock.float.4"] = StandardFunction { (it.execute("value") as Float).toFloat() }
    functions["rock.float.2_to_rock.float.8"] = StandardFunction { (it.execute("value") as Float).toDouble() }
    functions["rock.float.2_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Float).toByte() }
    functions["rock.float.2_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Float).toShort() }
    functions["rock.float.2_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Float).toInt() }
    functions["rock.float.2_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Float).toLong() }
    functions["rock.float.2_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Float).toByte() }
    functions["rock.float.2_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Float).toShort() }
    functions["rock.float.2_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Float).toInt() }
    functions["rock.float.2_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Float).toLong() }
    functions["rock.float.2_to_rock.string"] = StandardFunction { (it.execute("value") as Float).toString() }

//Conversions from rock.float.4
    functions["rock.float.4_to_rock.float.2"] = StandardFunction { (it.execute("value") as Float).toFloat() }
    functions["rock.float.4_to_rock.float.8"] = StandardFunction { (it.execute("value") as Float).toDouble() }
    functions["rock.float.4_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Float).toByte() }
    functions["rock.float.4_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Float).toShort() }
    functions["rock.float.4_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Float).toInt() }
    functions["rock.float.4_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Float).toLong() }
    functions["rock.float.4_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Float).toByte() }
    functions["rock.float.4_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Float).toShort() }
    functions["rock.float.4_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Float).toInt() }
    functions["rock.float.4_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Float).toLong() }
    functions["rock.float.4_to_rock.string"] = StandardFunction { (it.execute("value") as Float).toString() }

//Conversions from rock.float.8
    functions["rock.float.8_to_rock.float.2"] = StandardFunction { (it.execute("value") as Double).toFloat() }
    functions["rock.float.8_to_rock.float.4"] = StandardFunction { (it.execute("value") as Double).toFloat() }
    functions["rock.float.8_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Double).toByte() }
    functions["rock.float.8_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Double).toShort() }
    functions["rock.float.8_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Double).toInt() }
    functions["rock.float.8_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Double).toLong() }
    functions["rock.float.8_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Double).toByte() }
    functions["rock.float.8_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Double).toShort() }
    functions["rock.float.8_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Double).toInt() }
    functions["rock.float.8_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Double).toLong() }
    functions["rock.float.8_to_rock.string"] = StandardFunction { (it.execute("value") as Double).toString() }

//Conversions from rock.integer.signed.1
    functions["rock.integer.signed.1_to_rock.float.2"] = StandardFunction { (it.execute("value") as Byte).toFloat() }
    functions["rock.integer.signed.1_to_rock.float.4"] = StandardFunction { (it.execute("value") as Byte).toFloat() }
    functions["rock.integer.signed.1_to_rock.float.8"] = StandardFunction { (it.execute("value") as Byte).toDouble() }
    functions["rock.integer.signed.1_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Byte).toShort() }
    functions["rock.integer.signed.1_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Byte).toInt() }
    functions["rock.integer.signed.1_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Byte).toLong() }
    functions["rock.integer.signed.1_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Byte).toByte() }
    functions["rock.integer.signed.1_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Byte).toShort() }
    functions["rock.integer.signed.1_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Byte).toInt() }
    functions["rock.integer.signed.1_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Byte).toLong() }
    functions["rock.integer.signed.1_to_rock.string"] = StandardFunction { (it.execute("value") as Byte).toString() }

//Conversions from rock.integer.signed.2
    functions["rock.integer.signed.2_to_rock.float.2"] = StandardFunction { (it.execute("value") as Short).toFloat() }
    functions["rock.integer.signed.2_to_rock.float.4"] = StandardFunction { (it.execute("value") as Short).toFloat() }
    functions["rock.integer.signed.2_to_rock.float.8"] = StandardFunction { (it.execute("value") as Short).toDouble() }
    functions["rock.integer.signed.2_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Short).toByte() }
    functions["rock.integer.signed.2_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Short).toInt() }
    functions["rock.integer.signed.2_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Short).toLong() }
    functions["rock.integer.signed.2_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Short).toByte() }
    functions["rock.integer.signed.2_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Short).toShort() }
    functions["rock.integer.signed.2_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Short).toInt() }
    functions["rock.integer.signed.2_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Short).toLong() }
    functions["rock.integer.signed.2_to_rock.string"] = StandardFunction { (it.execute("value") as Short).toString() }

//Conversions from rock.integer.signed.4
    functions["rock.integer.signed.4_to_rock.float.2"] = StandardFunction { (it.execute("value") as Int).toFloat() }
    functions["rock.integer.signed.4_to_rock.float.4"] = StandardFunction { (it.execute("value") as Int).toFloat() }
    functions["rock.integer.signed.4_to_rock.float.8"] = StandardFunction { (it.execute("value") as Int).toDouble() }
    functions["rock.integer.signed.4_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Int).toByte() }
    functions["rock.integer.signed.4_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Int).toShort() }
    functions["rock.integer.signed.4_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Int).toLong() }
    functions["rock.integer.signed.4_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Int).toByte() }
    functions["rock.integer.signed.4_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Int).toShort() }
    functions["rock.integer.signed.4_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Int) }
    functions["rock.integer.signed.4_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Int).toLong() }
    functions["rock.integer.signed.4_to_rock.string"] = StandardFunction { (it.execute("value") as Int).toString() }

//Conversions from rock.integer.signed.8
    functions["rock.integer.signed.8_to_rock.float.2"] = StandardFunction { (it.execute("value") as Long).toFloat() }
    functions["rock.integer.signed.8_to_rock.float.4"] = StandardFunction { (it.execute("value") as Long).toFloat() }
    functions["rock.integer.signed.8_to_rock.float.8"] = StandardFunction { (it.execute("value") as Long).toDouble() }
    functions["rock.integer.signed.8_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Long).toByte() }
    functions["rock.integer.signed.8_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Long).toShort() }
    functions["rock.integer.signed.8_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Long).toInt() }
    functions["rock.integer.signed.8_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Long).toByte() }
    functions["rock.integer.signed.8_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Long).toShort() }
    functions["rock.integer.signed.8_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Long).toInt() }
    functions["rock.integer.signed.8_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Long).toLong() }
    functions["rock.integer.signed.8_to_rock.string"] = StandardFunction { (it.execute("value") as Long).toString() }

//Conversions from rock.integer.unsigned.1
    functions["rock.integer.unsigned.1_to_rock.float.2"] = StandardFunction { (it.execute("value") as Byte).toFloat() }
    functions["rock.integer.unsigned.1_to_rock.float.4"] = StandardFunction { (it.execute("value") as Byte).toFloat() }
    functions["rock.integer.unsigned.1_to_rock.float.8"] = StandardFunction { (it.execute("value") as Byte).toDouble() }
    functions["rock.integer.unsigned.1_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Byte).toByte() }
    functions["rock.integer.unsigned.1_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Byte).toShort() }
    functions["rock.integer.unsigned.1_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Byte).toInt() }
    functions["rock.integer.unsigned.1_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Byte).toLong() }
    functions["rock.integer.unsigned.1_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Byte).toShort() }
    functions["rock.integer.unsigned.1_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Byte).toInt() }
    functions["rock.integer.unsigned.1_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Byte).toLong() }
    functions["rock.integer.unsigned.1_to_rock.string"] = StandardFunction { (it.execute("value") as Byte).toString() }

//Conversions from rock.integer.unsigned.2
    functions["rock.integer.unsigned.2_to_rock.float.2"] = StandardFunction { (it.execute("value") as Short).toFloat() }
    functions["rock.integer.unsigned.2_to_rock.float.4"] = StandardFunction { (it.execute("value") as Short).toFloat() }
    functions["rock.integer.unsigned.2_to_rock.float.8"] = StandardFunction { (it.execute("value") as Short).toDouble() }
    functions["rock.integer.unsigned.2_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Short).toByte() }
    functions["rock.integer.unsigned.2_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Short).toShort() }
    functions["rock.integer.unsigned.2_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Short).toInt() }
    functions["rock.integer.unsigned.2_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Short).toLong() }
    functions["rock.integer.unsigned.2_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Short).toByte() }
    functions["rock.integer.unsigned.2_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Short).toInt() }
    functions["rock.integer.unsigned.2_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Short).toLong() }
    functions["rock.integer.unsigned.2_to_rock.string"] = StandardFunction { (it.execute("value") as Short).toString() }

//Conversions from rock.integer.unsigned.4
    functions["rock.integer.unsigned.4_to_rock.float.2"] = StandardFunction { (it.execute("value") as Int).toFloat() }
    functions["rock.integer.unsigned.4_to_rock.float.4"] = StandardFunction { (it.execute("value") as Int).toFloat() }
    functions["rock.integer.unsigned.4_to_rock.float.8"] = StandardFunction { (it.execute("value") as Int).toDouble() }
    functions["rock.integer.unsigned.4_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Int).toByte() }
    functions["rock.integer.unsigned.4_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Int).toShort() }
    functions["rock.integer.unsigned.4_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Int) }
    functions["rock.integer.unsigned.4_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Int).toLong() }
    functions["rock.integer.unsigned.4_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Int).toByte() }
    functions["rock.integer.unsigned.4_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Int).toShort() }
    functions["rock.integer.unsigned.4_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as Int).toLong() }
    functions["rock.integer.unsigned.4_to_rock.string"] = StandardFunction { (it.execute("value") as Int).toString() }

//Conversions from rock.integer.unsigned.8
    functions["rock.integer.unsigned.8_to_rock.float.2"] = StandardFunction { (it.execute("value") as Long).toFloat() }
    functions["rock.integer.unsigned.8_to_rock.float.4"] = StandardFunction { (it.execute("value") as Long).toFloat() }
    functions["rock.integer.unsigned.8_to_rock.float.8"] = StandardFunction { (it.execute("value") as Long).toDouble() }
    functions["rock.integer.unsigned.8_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as Long).toByte() }
    functions["rock.integer.unsigned.8_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as Long).toShort() }
    functions["rock.integer.unsigned.8_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as Long).toInt() }
    functions["rock.integer.unsigned.8_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as Long).toLong() }
    functions["rock.integer.unsigned.8_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as Long).toByte() }
    functions["rock.integer.unsigned.8_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as Long).toShort() }
    functions["rock.integer.unsigned.8_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as Long).toInt() }
    functions["rock.integer.unsigned.8_to_rock.string"] = StandardFunction { (it.execute("value") as Long).toString() }

//Conversions from rock.string
    functions["rock.string_to_rock.float.2"] = StandardFunction { (it.execute("value") as String).toFloat() }
    functions["rock.string_to_rock.float.4"] = StandardFunction { (it.execute("value") as String).toFloat() }
    functions["rock.string_to_rock.float.8"] = StandardFunction { (it.execute("value") as String).toDouble() }
    functions["rock.string_to_rock.integer.signed.1"] = StandardFunction { (it.execute("value") as String).toByte() }
    functions["rock.string_to_rock.integer.signed.2"] = StandardFunction { (it.execute("value") as String).toShort() }
    functions["rock.string_to_rock.integer.signed.4"] = StandardFunction { (it.execute("value") as String).toInt() }
    functions["rock.string_to_rock.integer.signed.8"] = StandardFunction { (it.execute("value") as String).toLong() }
    functions["rock.string_to_rock.integer.unsigned.1"] = StandardFunction { (it.execute("value") as String).toByte() }
    functions["rock.string_to_rock.integer.unsigned.2"] = StandardFunction { (it.execute("value") as String).toShort() }
    functions["rock.string_to_rock.integer.unsigned.4"] = StandardFunction { (it.execute("value") as String).toInt() }
    functions["rock.string_to_rock.integer.unsigned.8"] = StandardFunction { (it.execute("value") as String).toLong() }
    //}

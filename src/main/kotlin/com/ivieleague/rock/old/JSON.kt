...
object JSON {
    ...
    object LiteralReferences {
        val void = root("rock", "void", "literal")
        val integer = root("rock", "integer", "signed", "4", "literal")
        val string = root("rock", "string", "literal")
        val float = root("rock", "float", "8", "literal")
        val booleanTrue = root("rock", "boolean", "true")
        val booleanFalse = root("rock", "boolean", "false")
